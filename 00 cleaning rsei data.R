...
rsei_years <- split(rsei, rsei$submission.year)
...
pop_tox$rsei_cancer_bin <- ifelse(pop_tox$rsei.score == 0, 0, 1)
pop_tox$rsei_noncancer_bin <- ifelse(pop_tox$rsei.score == 0, 0, 1)
